...
pkgs_fn() {
    ...
    pkgs=(
        ...
        libraw-dev librsvg2-dev librubberband-dev librust-gstreamer-base-sys-dev libshine-dev libsmbclient-dev
        libsnappy-dev libsndfile1-dev libsndio-dev libsoxr-dev libspeex-dev libsqlite3-dev libssh-dev
...
if build "ffmpeg" "$ffmpeg_ver"; then
    ...
    mkdir build
    cd build || exit 1
    LDFLAGS+=" -Wl,-rpath,$install_dir/bin:$install_dir/../lib"
