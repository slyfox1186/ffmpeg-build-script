...
The FFmpeg build script provides an easy way to build a **static** FFmpeg on **<ins>Debian based systems</ins>** with **non-free and GPL codecs**, see https://ffmpeg.org/legal.html) included. It uses API calls to get you the latest version of each package available at the time of building.
